...
public class ServiceDiscoveryClient {
    ...
    public void register() {
        try {
            ...
            registered = true;
            System.out.println("[ServiceDiscoveryClient] Registered: " + serviceName + " at " + discoveryServerUrl);
        } catch (Exception e) {
    ...
    public String getServiceUrl(String targetServiceName) {
        try {
            ...
            System.err.println("[ServiceDiscoveryClient] Failed to get URL for " + targetServiceName + ": " + e.getMessage());
            return null;
        }
    }
}